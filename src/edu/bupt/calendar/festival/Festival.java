 ...
 * 用于确定节日(功能6)
 * 
 * 此文件取自http://download.csdn.net/download/opzoonzhuzhengke/3958071，有修改
 * 原出处未给出代码使用的开源协议
 * 
 * 由于此工程不需要所有节日，故修改了部分方法，注释了部分不需要的节日项
 * 
 * */
...
public final class Festival {
    ...
    public static String sFtvShort[] = {
    /*
     * 以下是1月份的节日 0 1 2
     */
    "元旦", // 0 1月1日
    ...
    public static String lFtvShort[] = {//
    "春节", // 0 正月初一
            "元宵", // 1 正月十五
            "端午", // 2 五月初五
            "七夕",// 3 七月初七
    ...
    public static String showSFtv(int month, int day) {
        ...
        // return sFtvShort[100];
        // else if (month == 12 && day == 4)
        // return sFtvShort[101];
        // else if (month == 12 && day == 5)
        // return sFtvShort[102];
        // else if (month == 12 && day == 7)
        // return sFtvShort[103];
        // else if (month == 12 && day == 9)
        // return sFtvShort[104];
        // else if (month == 12 && day == 10)
        // return sFtvShort[105];
        // else if (month == 12 && day == 11)
        // return sFtvShort[106];
        // else if (month == 12 && day == 12)
        // return sFtvShort[107];
        // else if (month == 12 && day == 13)
        // return sFtvShort[108];
        // else if (month == 12 && day == 15)
        // return sFtvShort[109];
        // else if (month == 12 && day == 20)
        // return sFtvShort[110];
        // else if (month == 12 && day == 21)
        // return sFtvShort[111];
        // else if (month == 12 && day == 24)
        // return sFtvShort[112];
        else if (month == 12 && day == 25)
            return sFtvShort[113];
        // else if (month == 12 && day == 26)
        // return sFtvShort[114];
        // else if (month == 12 && day == 29)
        // return sFtvShort[115];
        else
    ...
    public static String showLFtv(int month, int day, int dayOfmonth) {
        if (month == 1 && day == 1)
            return lFtvShort[0];// 春节
        else if (month == 1 && day == 15)
            return lFtvShort[1];// 正月十五
        ...
        // return lFtvShort[5];
            ...
            return lFtvShort[6];// 判断农历最后一个月是否是29天,是则这一天显示除夕.
        else if (month == 12 && day == 30 && dayOfmonth == 30)
            return lFtvShort[6];// 判断农历最后一个月是否是30天,是则这一天显示除夕.
        // else if (month == 12 && day == 8)
        // return lFtvShort[7];//腊八节
        // else if (month == 12 && day == 23)
        // return lFtvShort[8];//小年
        // else if (month == 12 && day == 24)
        // return lFtvShort[8];//小年，各地传统不一样
        // else if (month == 3 && day == 2)
        // return lFtvShort[12];//寒食
        // else if (month == 3 && day == 15)
        // return lFtvShort[8];//苗族姊妹节
        // else if (month == 5 && day == 24)
        // return lFtvShort[10];//苗族龙船节
        // else if (month == 6 && day == 24)
        // return lFtvShort[11];//彝族火把节
        // else if (month == 7 && day == 15)
        // return lFtvShort[13];//鬼节
        // else if (month == 10 && day == 4)
        // return lFtvShort[14];//苗年
        // else if (month == 10 && day == 15)
        // return lFtvShort[15];//下元节

        // else if (month == 11 && day == 28)
        // return lFtvShort[16];//测试数据
