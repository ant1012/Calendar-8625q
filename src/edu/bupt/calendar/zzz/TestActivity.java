	...
	protected void onCreate(Bundle savedInstanceState) {
       ...
       mFooterView.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				currentTime2.set(currentTime2.monthDay+62, currentTime2.month, currentTime2.year);
				...
				//					currentTime.set(currentTime.monthDay+62, currentTime.month, currentTime.year);
     ...
     //   public TextView mFooterView;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null)
            {
                ...
                //根据自定义的Item布局加载布局
                convertView = mInflater.inflate(R.layout.test_layout_items, null);
	    ...
	    for(int i=0;i<62;i++){
	    	...
	    	if(Lunar.isFestival()){
	    		...
	    		festivalTime.set(time);
	             ...
	             list.add(map);
	             Log.v("TestActivity", " method: festival: "+festival+" date: "+s);
	    	}
